                ...
                {hod && (
                  <div className="flex flex-col items-center justify-center py-4">
                    ...
                    >
                      ...
                      <div className="w-20 h-20 rounded-full border text-white shrink-0 overflow-hidden shadow-xl bg-zinc-900 border-amber-500/50 flex items-center justify-center relative">
                        {hod.avatarUrl ? (
                          <img 
                            src={hod.avatarUrl} 
                            alt={hod.name} 
                        ...
                        <div className="absolute inset-0 flex items-center justify-center font-display font-bold text-2xl bg-gradient-to-br from-amber-400 via-orange-500 to-red-600">
